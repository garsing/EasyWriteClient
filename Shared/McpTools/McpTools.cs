...
namespace WordAddIn1
{
    ...
    public static class McpTools
    {
            ...
            object wordApplication = null)
        {
            ...
            F_ManagePptShapeTool.Register(toolRegistry, wordApplication);
            F_ManagePptLibTool.Register(toolRegistry, wordApplication);
            ...
            F_RunTerminalTool.Register(toolRegistry, wordApplication);
            F_CloseTerminalTool.Register(toolRegistry, wordApplication);
            F_CloseDocumentTool.Register(toolRegistry, wordApplication);
            ...
            F_BrowserDownloadTool.Register(toolRegistry, wordApplication);
